...
public class UserServiceImpl implements UserService {
	...
	public void sendEmail(long pnrNo) throws AddressException {
		...
		final Email email = DefaultEmail.builder().from(new InternetAddress("gopisomarouthu1998@gmail.com"))
				.replyTo(new InternetAddress("gopisomarouthu1998@gmail.com"))
				.to(Lists.newArrayList(new InternetAddress("gopisomarouthu1998@gmail.com")))
